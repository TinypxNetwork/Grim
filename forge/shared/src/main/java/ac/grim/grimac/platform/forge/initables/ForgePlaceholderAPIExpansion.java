...
public class ForgePlaceholderAPIExpansion extends ForgePlaceholderExpansion {
    ...
    @Override
    public String onRequest(ServerPlayer player, @NotNull String params) {
        ...
        if (player != null) {
            GrimPlayer grimPlayer = GrimAPI.INSTANCE.getPlayerDataManager().getPlayer(player.getUUID());
