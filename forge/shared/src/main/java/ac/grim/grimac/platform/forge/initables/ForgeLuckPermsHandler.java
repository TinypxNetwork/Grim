...
public class ForgeLuckPermsHandler extends AbstractLuckPermsHandler implements StartableInitable {
    ...
    protected UUID contextSubjectUuid(ContextUpdateEvent event) {
        ...
        if (subject instanceof ServerPlayer player) return player.getUUID();
        return null;
    }
}